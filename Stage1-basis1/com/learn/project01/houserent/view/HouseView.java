package com.learn.project01.houserent.view;

import com.learn.project01.houserent.domain.House;
import com.learn.project01.houserent.service.HouseService;
import com.learn.project01.houserent.utils.Utility;
...
public class HouseView {
    ...
    private HouseService houseService = new HouseService(5);//设置数组的大小为5，即最多可容纳5个房屋信息
    //可以使用数组扩容来扩大这里的数组
    ...
    public void addHouse() {
        ...
        System.out.print("姓名: ");
        String name = Utility.readString(5); //不能超过5个字符
        System.out.print("电话: ");
    ...
    public void update() {
        ...
        if (!"".equals(name)) { //如果用户输入了信息，那么就执行修改
            house.setName(name);
        }
